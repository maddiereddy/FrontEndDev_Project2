...
//Used in-memory web api to test the app since I do not have a real database to make rest calls

export class InMemoryDataService implements InMemoryDbService {
  createDb() { //4 events hard coded for running app
    ...
    let events = [
      ...
      { id: 2, "name": "Angular2 vs React", "speaker": "Quincy Larson", "date": "04/14/2017",
        "startTime": "04/14/2017 18:00", "endTime": "02/14/2017 20:00",
      ...
      { id: 3, "name": "Angular2 Components", "speaker": "Jason Watmore", "date": "04/25/2017",
        "startTime": "04/25/2017 03:00 PM", "endTime": "04/25/2017 04:00 PM",
